...
time_span=np.linspace(0,100,500000) #8 orbital periods and 500 points
#Run the ODE solver
...
sphere1 = sphere(pos=vector(r1_sol[0,0],r1_sol[0,1],r1_sol[0,2]), radius=0.1, color=color.blue, make_trail=True, shininess=1, texture=textures.metal)
